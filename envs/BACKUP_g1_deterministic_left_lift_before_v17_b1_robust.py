...
class G1DeterministicLeftLiftEnv(gym.Env):
    ...
    def _target_joint_position(self, info: Dict[str, float]) -> np.ndarray:
        ...
        if (
            ...
            if self._emergency_landing:
                ...
                # V17-B1:
                # Preserve the existing low-swing blending, but allow
                # FULL task-space IK authority at peak swing.
                #
                # old:
                #     sw=1.0 -> blend=0.90
                #
    ...
    def _compute_reward(
        ...
        return float(reward), {
            ...
            "reward_version": "deterministic_left_lift_v17_b1_full_swing_ik_blend",
        }
