...
class G1BCLineResidualEnvV3(gym.Env):
    ...
    def __init__(
        ...
        for i, name in enumerate(self.joint_names):
            ...
            if name == "waist_yaw_joint":
            ...
            elif "ankle_roll_joint" in name:
                # V3:
                # Fine ablation showed 65% of V2 ankle-roll authority
                # gives the best line/survival compromise.
                #
                # V2 = 0.65
                # 0.65 * 0.65 = 0.4225
                ...
                # hip-pitch + knee remain at full authority.
    ...
    def _reward(self, action):
        ...
        # Lateral velocity must be stopped BEFORE large Y develops.
        lateral_velocity_penalty = (
            3.25 * vy * vy
            + 0.55 * abs(vy)
        )

        lateral_speed_excess = max(
            abs(vy) - 0.20,
            0.0,
        )

        lateral_speed_penalty = (
            2.0 * lateral_speed_excess
            + 5.0 * lateral_speed_excess ** 2
        )

        # =============================================================
        # ROOT ANGULAR STABILIZATION
        #
        # Attribution showed large pitch/yaw angular rates before fall.
        # wy gets the strongest penalty.
        # =============================================================
        ...
        # VELOCITY
        #
        # Forward locomotion is rewarded only while the robot is:
        #   upright
        #   close to Y=0
        #   reasonably aligned with yaw=0
        # =============================================================
        ...
        # =============================================================
        # STABLE WALKING BONUS
        # =============================================================

        stable_walk_bonus = 0.0
        ...
        if self.episode_step >= self.stand_frames:
            ...
            if (
                ...
                and z > 0.68
                and abs(y) < 0.08
                and abs(yaw) < math.radians(20.0)
                and abs(vy) < 0.25
            ):

                stable_walk_bonus = 0.45
