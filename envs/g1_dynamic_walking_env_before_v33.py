...
class G1DynamicWalkingEnv(gym.Env):
    ...
    def __init__(
        ...
        # v24/v25: correct-direction speed target.
        # The reward still discourages speeds above this value,
        # but v25 no longer terminates immediately at 0.35 m/s.
    ...
    def _compute_reward(self, action):
        ...
        # v24/v25: narrow allowed speed band.
        ...
        # v24/v25: stronger reward penalty for overspeed.
        ...
        if self.episode_step >= self.initial_stand_steps:
            ...
            # v24/v25: discourage both-feet-down sliding in the correct direction.
    ...
    def _is_fallen(self):
        ...
        if self.episode_step > self.initial_stand_steps + 80:
            ...
            # v28: restore stricter speed cap.
            # v25 learned good contact timing, but accelerated too much.

            if transition_alpha > 0.35 and directional_velocity > 0.45:
                return True

            if transition_alpha > 0.55 and directional_velocity >              self.max_correct_direction_speed:
                return True

            # Broad physical runaway cap.
