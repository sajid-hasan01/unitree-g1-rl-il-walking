...
OUTPUT = (
    ROOT
    / "results"
    / "g1_medium02_vs_medium08_dynamic_comparison.npz"
)
...
if not candidates:
    ...
    raise FileNotFoundError(
        "Could not locate clean medium_08 NPZ."
    )
...
if (
    ...
    print(
        "RESULT: MEDIUM_08 CONTACT AUDIT INVALID"
    )
    ...
    print(
        "RESULT: MEDIUM_08 IS DYNAMICALLY "
    ...
    if forward_gain >= 0.05:
        ...
        print(
            "MEDIUM_08 ALSO IMPROVES FORWARD PHYSICS."
        )

        print(
            "NEXT: promote medium_08 as the new "
        ...
        print(
            ...
            "projection on medium_08 before deciding."
        )
    ...
    print(
        "RESULT: MEDIUM_08 IS MODERATELY CLEANER"
    )
    ...
    print(
        "RESULT: MEDIUM_08 SHOWS THE SAME "
    ...
    print(
        "RESULT: MEDIUM_08 IS NOT CLEANER"
    )
