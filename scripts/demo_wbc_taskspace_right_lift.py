...
def main():
    parser = argparse.ArgumentParser(description="Demo WBC-lite task-space right-foot lift.")
    ...
    print("=" * 118)
    print("WBC-LITE TASK-SPACE RIGHT-FOOT LIFT DEMO")
        ...
        for step in range(args.max_steps):
            ...
            if step % args.print_every == 0:
                print(
                    ...
                    f"Lclr={info['left_foot_clearance']:.4f} Rclr={info['right_foot_clearance']:.4f}/{info['main_target_clearance']:.4f} "
                    ...
                    f"ang={info['root_ang_vel']:.3f} slip={info['support_slip']:.3f} rew={reward:+.3f}"
                )
