...
OUTPUT_CSV = (
    ROOT
    / "results"
    / "g1_medium02_foot_slip_source_decomposition.csv"
)
...
OUTPUT_NPZ = (
    ROOT
    / "results"
    / "g1_medium02_foot_slip_source_decomposition.npz"
)
...
print("=" * 205)
print("G1 STAGE 7V")
print("MEDIUM_02 FOOT-SLIP SOURCE DECOMPOSITION")
...
if int(
    ...
    raise RuntimeError(
        "medium_02 Stage-7T NONE baseline changed."
    )
