...
OUTPUT_CSV = (
    ROOT
    / "results"
    / "g1_medium04_foot_slip_source_decomposition.csv"
)
...
OUTPUT_NPZ = (
    ROOT
    / "results"
    / "g1_medium04_foot_slip_source_decomposition.npz"
)
...
print("=" * 205)
print("G1 STAGE 7V")
print("MEDIUM_04 FOOT-SLIP SOURCE DECOMPOSITION")
...
if int(
    ...
    raise RuntimeError(
        "medium_04 Stage-7T NONE baseline changed."
    )
