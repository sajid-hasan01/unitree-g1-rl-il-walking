...
def run_case(args, preload_amp: float, knee_bias: float) -> dict:
    ...
    while not terminated and not truncated:
        ...
        # Only measure force during the actual lift window.
...
def main() -> None:
    ...
    parser.add_argument(
        "--csv",
        default="experiments/amass_b3_15dof_residual_ppo_v3b/reports/wbc_v7_force_sweep.csv",
    )
    ...
    preload_values = [0.030, 0.034, 0.038, 0.042, 0.046]
    knee_values = [0.000, 0.002, 0.004, 0.006]

    rows = []

    print("=" * 130)
    print("WBC V7 FORCE SWEEP")
    print("Tuning by right-foot normal force during lift window, not only site clearance.")
    print("=" * 130)
