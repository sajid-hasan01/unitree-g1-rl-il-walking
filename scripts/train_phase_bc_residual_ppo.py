...
def main() -> None:
    ...
    parser.add_argument(
        "--out_dir",
        default="experiments/amass_b3_15dof_residual_ppo",
    )
    ...
    train_env = DummyVecEnv([make_env(args, render=False)])
    eval_env = DummyVecEnv([make_env(args, render=False)])

    checkpoint_callback = CheckpointCallback(
        save_freq=args.save_freq,
        save_path=str(model_dir / "checkpoints"),
        name_prefix="phase_bc_residual_ppo",
    ...
    print("=" * 100)
    print("TRAINING PHASE-BC RESIDUAL PPO")
    print("=" * 100)
    print("Output dir:", out_dir)
    print("Total timesteps:", args.total_timesteps)
    print("Dataset:", args.dataset)
    print("Phase-BC policy:", args.phase_bc_policy)
    ...
    print("Max episode steps:", args.max_episode_steps)
    print("=" * 100)
    ...
    final_model_path = model_dir / "phase_bc_residual_ppo_final.zip"
