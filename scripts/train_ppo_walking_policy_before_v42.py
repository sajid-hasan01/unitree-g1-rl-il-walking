...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Enable v40 mixed Reference State Initialization for the training environment. "
            "A fraction of training episodes start from random walking-reference frames. "
    ...
    parser.add_argument(
        ...
        default=0.35,
        help=(
            "Probability that a training reset uses RSI. "
            "0.35 means 35% RSI starts and 65% normal standing starts."
        ),
    )
    ...
    # Mixed RSI is training-only. EvalCallback must evaluate the normal standing-start task,
    ...
    print("RSI probability:", args.rsi_probability)
